...
export default function StatsBar() {
  ...
  return (
    <div className="relative z-10 w-full border-y border-blue-900/40 glass-panel bg-opacity-30 py-12 shadow-[0_0_50px_rgba(0,102,255,0.05)]">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between px-6">
        {stats.map((stat, index) => (
          <div key={index} className="flex flex-col items-center text-center my-4 md:my-0 group cursor-default">
            <h3 className="text-4xl md:text-5xl font-black text-white mb-2 font-display group-hover:text-cyan-300 transition-colors duration-300">
              {stat.value}
            </h3>
